...
namespace Silkroad
{
    ...
    public class MainGame : Game
    {
        ...
        public static string Path = @"E:\Silkroad\Clients\SilkroadOnline_GlobalOfficial_v1_225";
        ...
        {
            GraphicsDevice.Clear(ClearOptions.Target | ClearOptions.DepthBuffer, Color.SkyBlue, 1f, 0);
            base.Draw(gameTime);
